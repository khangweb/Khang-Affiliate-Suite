    ...
    <script type="module">
        app.component('v-media-videos', {
            ...
            mounted() {
                ...
                this.videos = this.uploadedVideos.map(video => {
                    return {
                        ...video,
                        url: this.resolveVideoUrl(video.path || video.url || '')
                    };
                });
            },
            ...
            methods: {
                ...
                resolveVideoUrl(url) {
                    ...
                    if (url.startsWith('http://') || url.startsWith('https://')) {
                        return url; // Đã là URL ngoài
                    }

                    // Ngược lại, thêm base URL từ Laravel storage
                    return  '{{ Storage::url("/") }}' + url.replace(/^\/?/, '');
                },
