                    ...
                    <div class="container px-[60px] max-1180:px-0">
                        <div class="mt-12 flex gap-9 max-1180:flex-wrap max-lg:mt-0 max-sm:gap-y-4">
                            ...
                            <div class="relative max-w-[590px] max-1180:w-full max-1180:max-w-full max-1180:px-5 max-sm:px-4">
                                ...
                                <!-- Xử lý cho Deeplink -->
                                 @php
                                    $isScrapedProduct = str_starts_with($product->sku, 'SCRAPED-');
                                @endphp
                                ...
                                @else
                                    ...
                                    {{-- Nếu là sản phẩm scraped thì thay thế nút buy bằng deeplink --}}
                                    <a
                                        href="{{ route('shop.deeplink.redirect' , ['id' => $product->id ]) }}"
                                        class="primary-button mt-5 inline-block w-full max-w-[470px] max-md:py-3 max-sm:mt-3 max-sm:rounded-lg max-sm:py-1.5 text-center"
                                    >
