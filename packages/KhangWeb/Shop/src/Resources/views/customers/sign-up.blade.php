    ...
    <x-slot:title>
        ...
        <div class="container mt-20 max-1180:px-5 max-md:mt-12">
            ...
            <div class="flex items-center gap-x-14 max-[1180px]:gap-x-9">
                <a href="{{ route('shop.home.index') }}" class="m-[0_auto_20px_auto]"
                ...
                <div class="mt-14 rounded max-sm:mt-8">
                    <x-shop::form :action="route('shop.customers.register.store')">
                        ...
                        <div class="alert error">
                            <div class="vfx_alert_body">
                                <i class="icon-close"></i>
                                {{ session('error') ?? implode(', ', $errors->all()) }}
                            </div>
                            <div class="vfx_alert_close"><i class="icon_close"></i></div>
                        </div>
                        @endif
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="text" class="px-6 py-4 max-md:py-3 max-sm:py-2"
                                name="first_name" rules="required" :value="old('first_name')"
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="text" class="px-6 py-4 max-md:py-3 max-sm:py-2"
                                name="last_name" rules="required" :value="old('last_name')"
                        ...
                        <x-shop::form.control-group>
                            ...
                            <x-shop::form.control-group.control type="email" class="px-6 py-4 max-md:py-3 max-sm:py-2"
                                ...
                                :aria-label="trans('shop::app.customers.signup-form.email')" aria-required="true" />
                        ...
                        <x-shop::form.control-group class="mb-6">
                            ...
                            <x-shop::form.control-group.control type="password"
                                ...
                                :value="old('password')" :label="trans('shop::app.customers.signup-form.password')"
                                :placeholder="trans('shop::app.customers.signup-form.password')" ref="password"
                                :aria-label="trans('shop::app.customers.signup-form.password')" aria-required="true" />
